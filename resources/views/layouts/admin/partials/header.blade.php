									...
									<ul>
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="{{ asset('assets/admin/img/!sample-user.jpg') }}" alt="Joseph Doe Junior" class="rounded-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="{{ asset('assets/admin/img/!sample-user.jpg') }}" alt="Joseph Junior" class="rounded-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="{{ asset('assets/admin/img/!sample-user.jpg') }}" alt="Joe Junior" class="rounded-circle" />
												</figure>
					...
					<div id="userbox" class="userbox">
						<a href="#" data-bs-toggle="dropdown">
							<figure class="profile-picture">
								<img src="{{ asset('assets/admin/img/!logged-user.jpg') }}" alt="Joseph Doe" class="rounded-circle" data-lock-picture="{{ asset('assets/admin/img/!logged-user.jpg') }}" />
							</figure>
